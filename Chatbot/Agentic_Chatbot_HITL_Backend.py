...
def chat_node(state: ChatState):
    ...
    system_message = SystemMessage(
        content=(
            ...
            "Call this tool immediately with the stock symbol and quantity. "
            "Do NOT ask the user to confirm the purchase yourself and do NOT reply "
            "with a text confirmation message. The system automatically pauses and "
            "asks the human for approval after this tool is invoked.\n"
